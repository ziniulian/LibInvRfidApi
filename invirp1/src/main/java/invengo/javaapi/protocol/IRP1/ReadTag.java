...
public class ReadTag extends BaseMessage implements IEventHandle {
	...
	public void setType(byte type){
		...
		if (this.rmb == ReadMemoryBank.EPC_TID_UserData_6C_2 && this.type == 0x02){
			setMeasureTemperature(true);
		}else {
			setMeasureTemperature(false);
		}
	}
	...
	//XC-IUT1501-01芯片测温标签初始值及步进值&是否测温
	...
	public void setMeasureTemperature(boolean measureTemperature) {
		...
		if (this.rmb == ReadMemoryBank.EPC_TID_UserData_6C_2 && this.measureTemperature){//测温
			msgBody[1] = 0x02;
			this.type = 0x02;
		}
	}
