...
public class ReadTagConfig_6C extends BaseMessage {
	...
	public ReadTagConfig6CReceivedInfo getReceivedMessage() {
		...
		return new ReadTagConfig6CReceivedInfo(data);
	}

	public class ReadTagConfig6CReceivedInfo extends invengo.javaapi.core.ReceivedInfo {

		private static final long serialVersionUID = 2287324618390194155L;

		public ReadTagConfig6CReceivedInfo(byte[] buff) {
			super(buff);
		}
