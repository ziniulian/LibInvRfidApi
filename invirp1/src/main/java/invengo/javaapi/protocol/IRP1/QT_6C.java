...
public class QT_6C extends BaseMessage implements IEventHandle {
	...
	public QT6CReceivedInfo getReceivedMessage() {
		byte[] data = Decode.getRxMessageData(super.rxData);
		if (data == null) {
			return null;
		}
		return new QT6CReceivedInfo(data);
	}

	public class QT6CReceivedInfo extends invengo.javaapi.core.ReceivedInfo {

		public QT6CReceivedInfo(byte[] buff) {
			super(buff);
		}
