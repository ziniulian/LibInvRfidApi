...
public class GetTagAccessPwd_6C extends BaseMessage implements IEventHandle {
	...
	public GetTagAccessPwd6CReceivedInfo getReceivedMessage() {
		byte[] data = Decode.getRxMessageData(super.rxData);
		if (data == null) {
			return null;
		}
		return new GetTagAccessPwd6CReceivedInfo(data);
	}

	public class GetTagAccessPwd6CReceivedInfo extends invengo.javaapi.core.ReceivedInfo {

		private static final long serialVersionUID = 112599945387908493L;

		public GetTagAccessPwd6CReceivedInfo(byte[] buff) {
			super(buff);
		}
